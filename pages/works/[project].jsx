            ...
            <>
                ...
                >
                    <div className={styles.heroBackground}>
                        {project.cover ? (
                            <Image 
                                src={`/images/projects/${theme}/${project.dir}/${project.cover}`}
                                alt={project.title}
                                fill
                                priority
                            ...
                            <Image 
                                src={`/images/projects/${theme}/${project.dir}/${project.images[0]}`}
                                alt={project.title}
                                fill
                                priority
                                className={styles.heroBackgroundImage}
                                                ...
                                                >
                                                    <div className={styles.relatedImageContainer}>
                                                        {relatedProject.cover ? (
                                                            <Image 
                                                                src={`/images/projects/${relatedProject.theme}/${relatedProject.dir}/${relatedProject.cover}`}
                                                            ...
                                                            <Image 
                                                                src={`/images/projects/${relatedProject.theme}/${relatedProject.dir}/${relatedProject.images[0]}`}
                                                                alt={relatedProject.title}
                                                                width={400}
                                                                height={250}
                                                                className={styles.relatedImage}
                            ...
                            <div className={styles.lightboxContent}>
                                ...
                                <div className={styles.lightboxImageContainer}>
                                    <AnimatePresence mode="wait">
                                        ...
                                        >
                                            <Image 
                                                src={`/images/projects/${projectDetails.theme}/${projectDetails.project.dir}/${projectDetails.project.images[lightboxIndex]}`}
